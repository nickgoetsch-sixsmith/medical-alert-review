...
export function GET() {
  ...
  const content = [
    ...
    "- /lively-review: Full review of Lively (Best Buy Health) — cheapest fall-detection add-on",
    "- /mobilehelp-review: Full review of MobileHelp — no equipment fees, widest in-home range",
    "- /adt-medical-alert-review: Full review of ADT Medical Alert (ADT Health) — lifetime price lock",
    "- /logicmark-review: Full review of LogicMark Freedom Alert — no-monthly-fee (no monitoring center)",
